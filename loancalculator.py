...
# Create a user defined class named: LoanCalculator which holdes its own 
...
class LoanCalculator:
    def __init__(self):     # Special method in Python Class-Constructor of a Python Class
        ...
        #Create button to calculate payment. When button is clicked, it will call the computer payment function
        
        btnComputerPayment = Button(window, text="Computer Payment", bg="red", fg="white",font="Helvetica 12 bold", command=self.computePayment).grid(row=6,column=2, sticky=E)
        btnClear = Button(window, text="Clear",bg="blue",fg="white",font="Helvetica 14 bold", command=self.delete_all).grid(row=6,column=8,padx=20, pady=20,sticky=E)
...
# Call the class to call the application
LoanCalculator()